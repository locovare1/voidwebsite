...
export const metadata = {
  title: "Void Outreach Program | Void Esports",
  description:
    "Join the Void Outreach Program and become an official brand ambassador! Help Void grow in every game you play.",
  openGraph: {
    title: "Void Outreach Program | Void Esports",
    description:
      "Join the Void Outreach Program and become an official brand ambassador! Help Void grow in every game you play.",
    url: "https://www.voidesports.org/ambassadors",
    images: ["https://www.voidesports.org/logo.png"],
    type: "website",
  },
};
    ...
    <main className="min-h-screen bg-black text-gray-100">
      ...
      <section className="py-16 px-6 bg-[#0F0F0F]">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl font-bold text-center text-white mb-8">What is it?</h2>
      ...
      <section className="py-16 px-6 bg-black">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl font-bold text-center text-white mb-8">Why we&apos;re doing this?</h2>
          <div className="bg-[#18181b] rounded-xl shadow-md p-8">
            <p className="text-lg text-gray-300 leading-relaxed">
      ...
      <section className="py-16 px-6 bg-[#0F0F0F]">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl font-bold text-center text-white mb-8">What you get out of it?</h2>
      ...
      <section className="py-16 px-6 bg-black">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl font-bold text-center text-white mb-8">Our Brand Ambassadors</h2>
